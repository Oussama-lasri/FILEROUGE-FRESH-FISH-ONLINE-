<template>
    ...
    <section class="register">
        ...
        <form @submit.prevent="login" class="flex mb-10 flex-col justify-center  items-center">
            ...
            <router-link to="/register" class="py-5  w-1/2 mx-auto text-sm text-gray-600 hover:text-gray-950">Don't have an
                account? Register here.</router-link>
            <div class="text-left justify-center mb-6">
                ...
                <div class="w-[40rem]">
                    <input v-model="form.email" class="form-input block pl-10 rounded-md h-12 w-full focus:bg-white"
                        id="my-textfield" type="text">
                </div>
            </div>
            <div class="flex flex-col  text-left justify-center mb-6">
                ...
                <div class="w-[40rem]">
                    <input v-model="form.password" class="form-input block pl-10 rounded-md h-12 w-full focus:bg-white"
                        id="my-textfield" type="text">
                </div>
            </div>
