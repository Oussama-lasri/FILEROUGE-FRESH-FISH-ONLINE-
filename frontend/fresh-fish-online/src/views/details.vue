<template>
        ...
        <div class="space-y-4 lg:grid lg:grid-cols-3 lg:items-start lg:gap-6 lg:space-y-0" style="cursor: auto;">
            ...
            <a href="https://stackdiary.com/" class="group">
                ...
                <div class="aspect-w-5  aspect-h-8">
                    ...
                    <img class="object-cover w-96 shadow-lg  group-hover:opacity-75" :src="fish.image"
                        alt="Featured Photo" style="cursor: auto;">
            ...
            <div class="sm:col-span-2" style="cursor: auto;">
                <div class="mt-2" style="cursor: auto;">
                    <h4 class="text-lg leading-6 font-semibold font-sans text-skin-inverted group-hover:text-skin-primary"
                        style="cursor: auto;">DISCOVER MORE <a href="" class="font-bold text-myblue">{{ fish.category.name }}</a>
                    </h4>
                    <hr class="my-7">
    ...
    <div class="text-center mb-24 relative my-8">
        ...
        <div class="gap-2.5 inline-flex justify-center items-center p-2.5 text-left font-normal rounded-[10px] font-['Inter'] text-[rgba(0,118,212,1)] [box-shadow:0px_0px_0px_1px_rgba(0,_118,_212,_1)_inset] [box-shadow-width:1px]"
            style="props.style">
