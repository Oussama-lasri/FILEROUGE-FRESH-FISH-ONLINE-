                    ...
                    <div class="flex-auto px-0 pt-0 pb-2">
                        <div class="p-0 overflow-x-auto">
                            <table
                                ...
                                <tbody class="border-t" :key="fish.id" v-for="fish in fishes">
                                    <tr>
                                        <td
                                            class=" align-middle bg-transparent  border-b-0 whitespace-nowrap shadow-transparent">
                                            <div class="flex px-2">
                                                <div class="my-auto ml-4">
                                                    <h6 class="mb-0 text-sm leading-normal dark:text-white">#{{ fish.id }}
                                                    </h6>
                                                </div>
                                            </div>
                                        </td>
...
async function allfish() {
    try {
        let response = await axios.get('http://127.0.0.1:8000/api/fishes/showAll');
