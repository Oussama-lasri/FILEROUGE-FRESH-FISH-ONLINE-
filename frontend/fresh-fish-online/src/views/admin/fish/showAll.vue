<template>
    ...
    <section class="flex flex-wrap text-center container my-24 mx-auto">
        <div class="w-full flex justify-between">
            ...
            <RouterLink to="/fish/add"><a href="" class="text-white bg-green-600 hover:bg-green-800 p-3 rounded m-6">add product</a></RouterLink>
        </div>
                ...
                <div class="flex-auto px-0 pt-0 pb-2">
                    <div class="p-0 overflow-x-auto">
                        <table
                            ...
                            <tbody class="border-t " v-for="fish in fishes">
                                <tr >
                                    <td
                                        class=" align-middle bg-transparent  border-b-0 whitespace-nowrap shadow-transparent">
                                        <div class="flex px-2">
                                            <div class="my-auto ml-4">
                                                <h6 class="mb-0 text-sm leading-normal dark:text-white">#{{fish.id}}</h6>
                                            </div>
                                        </div>
                                    </td>
                                    <td
                                    ...
                                    <td
                                        class="p-2 align-middle bg-transparent border-b-0 text-center whitespace-nowrap shadow-transparent">
                                        <span
                                            class="text-xs font-semibold leading-tight dark:text-white dark:opacity-60">{{fish.category}}</span>
                                    </td>
                                    <td
                                        class="p-2 align-middle bg-transparent border-b-0 text-center whitespace-nowrap shadow-transparent">
                                        <span
