        ...
        <div class="relative z-50 ">
            ...
            <div class="fixed inset-0 overflow-hidden">
                <div class="absolute inset-0 overflow-hidden">
                    ...
                    <div @click="" class="w-full bg-black/40 h-full"></div>
                                ...
                                <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-6 h-screen scrollbar-thumb-primary-700 scrollbar-track-secondary-500 scrollbar-thin">
                                    <div class="flex items-start justify-between">
                                        ...
                                        <div class="ml-3 flex h-7 items-center">
                                            <button @click="" type="button" class="-m-2 p-2 text-gray-400 hover:text-gray-500">
                                                <!-- close cart -->
                                                    ...
                                                    <div class="ml-4 flex flex-1 flex-col justify-around">
                                                        <div>
                                                            <div class="flex justify-between text-base font-medium text-gray-900">
                                                                ...
                                                                <p class="ml-4 font-semibold">{{  }}DH</p>
                                                            </div>
                                                        </div>
                                                        <div class="flex items-end justify-between text-sm">
                                                            ...
                                                            <div class="flex">
                                                                <button @click="" type="button" class="font-semibold text-red-500 hover:text-indigo-500">
                                                                    Remove {{ item.id }}
                                                                </button>
                                                            </div>
                                                        </div>
