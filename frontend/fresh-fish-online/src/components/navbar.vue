<template>
    <nav class="z-50">
        <div class="bg-black text-gray-100 py-6 px-6 shadow flex flex-col md:flex-row justify-between items-center">
    ...
    <div class="flex grow  justify-center items-center">
      ...
      <div class="mx-5">
        <svg xmlns="http://www.w3.org/2000/svg"
          class="icon cursor-pointer icon-tabler icon-tabler-search" width="24" height="24" viewBox="0 0 24 24"
