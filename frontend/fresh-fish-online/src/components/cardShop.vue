<template>
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td class="w-32 p-4">
                        <img src="../assets/images/fishCard.png" alt="Fish">
                    </td>
    ...
    <div class="flex justify-end gap-y-10 flex-col m-24 items-end  ">
        ...
        <div
            class="flex flex-col items-end right-px text-black font-medium ">
            <p class="text-2xl ">Net Total: $80.00</p>
        </div>
        <p class=" text-xl font-medium text-black h-6 ">
            Tax Total: $0.00
        </p>
        <div
            class=" flex flex-col items-end right-0 text-black font-medium ">
            <p class="text-2xl ">Sub Total: $80.00</p>
        </div>
        <button class="bg-myblue py-3 px-5 rounded-md text-white hover:bg-blue-900">Checkout</button>
    </div>
